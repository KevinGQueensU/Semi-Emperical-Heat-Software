...
# Force a GUI backend and turn on interactive mode
matplotlib.use("TkAgg")  # or "TkAgg" if Qt isn't available
plt.ion()
...
if True:
    ...
    rho *= 1e3  # kg/m^3
    sim.heateq_solid_3d_test(beam, medium, Lx, Ly, Lz, rho, Cp, k, 1,
                        T0=298, T_amb=298, T0_faces=[273, 273, 298, 298, 298, 298],
                        rad_bnd=[False, False, True, True, True, True], eps = 0.9,
